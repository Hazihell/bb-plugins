...
- System sans for interface text; the monospace stack for code, paths, refs, and counts. No font binary is bundled: a locally installed Berkeley Mono is used when present, else the system monospace fallback.
